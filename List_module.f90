...
! This module implements a linked list of objects. The module is used by the Observer module that holds a list of lizards. In our specific simulation, it holds only one lizard.
